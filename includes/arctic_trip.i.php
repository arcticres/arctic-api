...
class Arctic_Trip extends ArcticModel
{
	...
	public function __construct() {
		...
		$this->_addMultipleReference('pricinglevels','Arctic_Trip_PricingLevel' , 'pricinglevel' , array( 'id' => 'tripid' ) );
		$this->_addMultipleReference('components','Arctic_Trip_Component' , 'component' , array( 'id' => 'tripid' ) );
	}
}